...
{% if easy_leak %}
print("La función nos devuelve los offsets de las funciones para calcular PIE y ASLR, intenta explotarlo sabiendo estos datos!")
...
{% endif %}
{% endif %}
print("Ahora que has aprendido todo, intenta implementarlo por tu cuenta usando pwntools! :)")
"""