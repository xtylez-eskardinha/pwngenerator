...
\end{figure}
\FloatBarrier
Para poder identificar el canario en el stack de forma sencilla, suele estar ubicado en \acrshort{ebp} - `0xc' y acaba en un byte nulo.
...
Debido a que el proyecto está enfocado al ámbito educativo se ha pensado que la mejor solución es entregar plantillas paso a paso con el mecanismo de resolución esperado para el problema propuesto.
